...
func mustNote(t testing.TB, s string) music.Note {
	t.Helper()
	n, err := music.ParseNote(s)
	if err != nil {
...
func chordOf(t testing.TB, root string, q music.ChordQuality) music.Chord {
	return music.Chord{Root: mustNote(t, root), Quality: q}
}
